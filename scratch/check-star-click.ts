...
async function main() {
  ...
  try {
    ...
    // Click star 5
    console.log('Clicking star-5 using locator...');
    ...
    const checkResult = await page.evaluate(() => {
      ...
      const starsHtml = starsContainer ? starsContainer.innerHTML : 'container not found';
    ...
    console.log('DOM State after locator click:', JSON.stringify(checkResult, null, 2));
